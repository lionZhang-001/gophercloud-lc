...
import (
	...
	"gophercloud-lc/openstack/networking/v2/extensions/external"
	"gophercloud-lc/openstack/networking/v2/extensions/security/groups"
	"gophercloud-lc/openstack/networking/v2/extensions/security/rules"
	"gophercloud-lc/openstack/networking/v2/networks"
	"gophercloud-lc/openstack/networking/v2/ports"
)
